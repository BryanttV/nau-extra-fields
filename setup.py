#!/usr/bin/env python
"""
Package metadata for nau_extra_fields.
"""
...
VERSION = get_version("nau_extra_fields", "__init__.py")
...
setup(
    name="nau-extra-fields",
    version=VERSION,
    description="""One-line description for README and other doc files.""",
    long_description=README + "\n\n" + CHANGELOG,
    author="edunext",
    author_email="edunext@technical.co",
    url="https://github.com/edunext/nau-extra-fields",
    packages=find_packages(
        include=["nau_extra_fields", "nau_extra_fields.*"],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "nau_extra_fields = nau_extra_fields.apps:NauExtraFieldsConfig",
        ],
    },
)
