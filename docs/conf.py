...
"""
nau-extra-fields documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'nau-extra-fields',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edunext/nau-extra-fields",
...
#
# html_title = 'nau-extra-fields v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'nau_extra_fields'),
                os.path.join(root_path, 'nau_extra_fields/migrations')])
