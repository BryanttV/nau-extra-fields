...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd nau_extra_fields && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd nau_extra_fields && i18n_tool generate

detect_changed_source_translations:
	cd nau_extra_fields && i18n_tool changed
...
pull_translations:
	find nau_extra_fields/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/nau-extra-fields/nau_extra_fields/conf/locale:nau_extra_fields/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd nau_extra_fields && i18n_tool dummy
